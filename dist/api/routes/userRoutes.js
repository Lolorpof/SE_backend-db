...
const jobSeekerControllers_1 = require("../controllers/jobSeekerControllers");
const employerControllers_1 = require("../controllers/employerControllers");
...
userRouter
    .route("/job-seeker")
    .post(auth_1.checkUnauthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().register);
...
userRouter
    ...
    .post(auth_1.checkUnauthenticated, multer_1.uploadRegisterImageMiddleware, auth_1.checkUploadedSingleFile, jobSeekerControllers_1.jobSeekerControllers.instance().uploadRegistrationImage);
...
userRouter
    ...
    .post(auth_1.checkUnauthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().login)
    .get(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().getCurrent)
    .delete(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().logout);
 ...
 */
userRouter.get("/job-seeker/oauth/google", auth_1.checkUnauthenticatedOauth, jobSeekerControllers_1.jobSeekerControllers.instance().googleLogin);
userRouter.get("/job-seeker/oauth/google/callback", jobSeekerControllers_1.jobSeekerControllers.instance().googleLogin);
...
userRouter
    ...
    .post(auth_1.checkAuthenticated, multer_1.uploadProfileImageMiddleware, auth_1.checkUploadedSingleFile, jobSeekerControllers_1.jobSeekerControllers.instance().uploadProfilePicture);
...
userRouter
    ...
    .post(auth_1.checkAuthenticated, multer_1.uploadResumeImageMiddleware, auth_1.checkUploadedSingleFile, jobSeekerControllers_1.jobSeekerControllers.instance().uploadResume);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editUsername);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editEmail);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editFullName);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editAbout);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editAddress);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editContact);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editPassword);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editSkill);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, jobSeekerControllers_1.jobSeekerControllers.instance().editVulnerability);
...
userRouter
    .route("/employer")
    .post(auth_1.checkUnauthenticated, employerControllers_1.employerControllers.instance().register);
...
userRouter
    ...
    .post(auth_1.checkUnauthenticated, multer_1.uploadRegisterImageMiddleware, auth_1.checkUploadedSingleFile, employerControllers_1.employerControllers.instance().uploadRegistrationImage);
...
userRouter
    .route("/employer/auth")
    .post(auth_1.checkUnauthenticated, employerControllers_1.employerControllers.instance().login)
    .get(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().getCurrent)
    .delete(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().logout);
 ...
 *         description: Redirect user to home page
 */
userRouter.get("/employer/oauth/google", auth_1.checkUnauthenticatedOauth, employerControllers_1.employerControllers.instance().googleLogin);
userRouter.get("/employer/oauth/google/callback", employerControllers_1.employerControllers.instance().googleLogin);
...
userRouter
    ...
    .post(auth_1.checkAuthenticated, multer_1.uploadProfileImageMiddleware, auth_1.checkUploadedSingleFile, employerControllers_1.employerControllers.instance().uploadProfilePicture);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().editUsername);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().editEmail);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().editFullName);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().editAbout);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().editAddress);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().editContact);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, employerControllers_1.employerControllers.instance().editPassword);
// [Company]
...
userRouter
    .route("/company")
    .post(auth_1.checkUnauthenticated, companyControllers_1.companyControllers.instance().register);
...
userRouter
    ...
    .post(auth_1.checkUnauthenticated, multer_1.uploadRegisterImageMiddleware, auth_1.checkUploadedSingleFile, companyControllers_1.companyControllers.instance().uploadRegistrationImage);
...
userRouter
    .route("/company/auth")
    .post(auth_1.checkUnauthenticated, companyControllers_1.companyControllers.instance().login)
    .get(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().getCurrent)
    .delete(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().logout);
...
userRouter
    ...
    .post(auth_1.checkAuthenticated, multer_1.uploadProfileImageMiddleware, auth_1.checkUploadedSingleFile, companyControllers_1.companyControllers.instance().uploadProfilePicture);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().editOfficialName);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().editEmail);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().editAbout);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().editAddress);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().editContact);
...
userRouter
    ...
    .put(auth_1.checkAuthenticated, companyControllers_1.companyControllers.instance().editPassword);
/**
 * @openapi
 * /api/user/current:
 *   get:
 ...
 */
userRouter.get("/current", auth_1.checkAuthenticated, userControllers_1.userControllers.instance().getCurrentUser);
