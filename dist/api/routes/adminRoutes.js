...
const adminsControllers_1 = require("../controllers/adminsControllers");
...
adminRouter
    .route("/")
    .post(auth_1.checkPermissionHeader, adminsControllers_1.adminControllers.instance().create);
...
adminRouter
    .route("/auth")
    .post(auth_1.checkUnauthenticated, adminsControllers_1.adminControllers.instance().login)
    .get(auth_1.checkAuthenticated, adminsControllers_1.adminControllers.instance().getCurrent)
    .delete(auth_1.checkAuthenticated, adminsControllers_1.adminControllers.instance().logout);
// approve user(POST)
/**
 * @openapi
 * /api/admin/approve:
...
adminRouter
    .route("/approve")
    .post(auth_1.checkAuthenticated, auth_1.checkAdmin, adminsControllers_1.adminControllers.instance().approvingUser)
    .get(auth_1.checkAuthenticated, auth_1.checkAdmin, adminsControllers_1.adminControllers.instance().getAllApproveRequest);
