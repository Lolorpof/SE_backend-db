...
exports.super_url = exports.url = void 0;
...
// checking template
const parsed = schemas_1.connStringSchema.safeParse(pg_object);
if (!parsed.success) {
    console.log(`>>> ${(0, zod_validation_error_1.fromError)(parsed.error)} <<<`);
}
const super_url = `postgres://${pg_superuser}:${pg_superpassword}@${pg_host}:${pg_port}/${pg_db}`;
exports.super_url = super_url;
